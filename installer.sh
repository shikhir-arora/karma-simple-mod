...
function failed {
    ...
    echo -e "\nFailed to install. Please visit https://github.com/shikhir-arora/karma-simple-mod/issues.\n"
    exit 1
}
...
git clone --recursive --depth 1 https://github.com/shikhir-arora/karma-simple-mod.git || failed "Cannot install. Ensure you have permissions!"
echo ""
...
cd "$directory"
mv "$tempinstalldir"/karma-simple-mod karma-simple-mod
rm -r "$tempinstalldir"
